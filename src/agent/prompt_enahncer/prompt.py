...
Your job is to analyse the user prompt, and enahnce it to perform best sqa on the web page screenshot accordingly.
...
- Always make sure that the ' Web Page ' is for your help, do not extract or change the user prompt by extractng text from the ' Web Page '
